...
\hypersetup{pdftitle={Efficient Regular Pattern Matching avoiding Denial of Service}, %nao suporta acentos
   pdfkeywords ={regular expressions, ReDoS, position automata, nondeterministic finite automata, pattern matching},
   pdfsubject = {Masters Thesis},
	bookmarksnumbered=true,
   pdfauthor ={Daniel Resende}, % see other options on manual (can be page) needs empty line on bibitem
   plainpages=false, 
   pdfborder={0 0 0},
...
\title{Efficient Regular Pattern Matching avoiding Denial of Service}
...
\include{chapters/state-of-the-art/sota}

%\chapter{Desenho da Arquitetura}\label{chap:syst}
\include{chapters/counting/counting}
...
%% appendix
%\appendix
%\include{appendices/algorithms/nfa-pos-count}
%\include{appendices/algorithms/table-matcher}
%% \include{app1}

\include{appendices/lark/lark_appendix}
%\include{appendices/code/builder_cases}
