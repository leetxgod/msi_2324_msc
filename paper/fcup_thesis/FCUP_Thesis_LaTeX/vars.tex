...
\thesistitle{Author name disambiguation in publications using graph neural networks}

% Your thesis type Doctoral Thesis or Masters Thesis \ttype
\thesistype{Masters Thesis}

% Your supervisor's name
\supervisor[mailto:fmsilva@fc.up.pt]{Fernando \textsc{Silva}}

% Your supervisor's name
% To hide the Co-Supervisor field, just comment out \cosupervisor
\cosupervisor[mailto:mepsilva@fc.up.pt]{Miguel \textsc{Silva}}
